 ...
 *
 * Use cases now link directly to products. Use /api/products/[id]/use-cases instead.
  ...
  return NextResponse.json(
    {
      ...
      message: 'The functions layer has been eliminated. Use /api/products/[productId]/use-cases instead.',
      replacement: '/api/products/[productId]/use-cases',
